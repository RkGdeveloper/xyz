...
<sf:form class="w3-card-4"  action="insertEmployeeDetails.ems" style="max-width:500px;margin: auto; padding:10px;" commandName="EmployeeDetails" modelAttribute="EmployeeDetails" method="POST">
  <p>
  <label>First Name</label>
  <sf:input class="w3-input" type="text" path="firstName"/></p>

	<p>
  <sf:errors class="w3-input"  path="firstName" /></p>
  
  <p>
  <label>Last Name</label>
  <sf:input class="w3-input" type="text" path="lastName" /></p>
  	<p >
  <sf:errors class="w3-input"  path="lastName" /></p>
  ...
  <p>
  <label>Salary</label>
  <sf:input class="w3-input" type="number" path = "salary" /></p>
  ...
  <sf:input class="w3-input" type="number" path="contactNo" /></p>
    
  <p>
  <label>Address Line1</label>
  <sf:input class="w3-input" type="text" path="addressline1" /></p>
  	<p>
  <sf:errors class="w3-input"  path="addressline1" /></p>
  ...
  <sf:input class="w3-input" type="text" path="addressline2" /></p>
  	<p>
  <sf:errors class="w3-input"  path="addressline2" /></p>
  ...
  <sf:input class="w3-input" type="text" path="city" /></p>
  	<p>
  <sf:errors class="w3-input"  path="city" /></p>
  
  
  
  <p>
  <label>PinCode</label>
  <sf:input class="w3-input" type="number" path="pincode" /></p>
  
  <p>
  <label>State</label>
  <sf:input class="w3-input" type="text" path="state" /></p>
    	<p>
  <sf:errors class="w3-input"  path="state" /></p>
